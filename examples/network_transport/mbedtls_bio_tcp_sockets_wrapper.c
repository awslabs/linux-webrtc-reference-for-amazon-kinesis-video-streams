 ...
 */
int xMbedTLSBioTCPSocketsWrapperSend(void *ctx, const unsigned char *buf,
                                     size_t len) {
  ...
  /* The send might be failed because of out-of-memory/interrupted by system
   * call/EAGAIN. */
 ...
 */
int xMbedTLSBioTCPSocketsWrapperRecv(void *ctx, unsigned char *buf,
                                     size_t len) {
  int32_t xReturnStatus;
