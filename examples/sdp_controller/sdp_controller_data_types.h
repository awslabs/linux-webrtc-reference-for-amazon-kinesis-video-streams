...
typedef struct SdpControllerMediaDescription {
  ...
  // https://tools.ietf.org/html/rfc4566#section-5.4. Given these are free-form
  // strings, the length could be anything. Although our SDK parses this
  // information, the SDK does not use it. Leaving this attribute in if SDK uses
  // it in the future
